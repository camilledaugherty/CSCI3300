...
public class Specialist extends HealthCare {
    ...
    public double salaryIncrease() {
        //salary increase: 4.5% plus 1% for each quinquennial of service
        double oldSalary = this.getSalary();
        double salaryIncrease = oldSalary*0.045; //salary increase will be added onto old salary, starts as 4.5% of old salary
